...
<div class="layui-card-body">
    <form class="layui-form" onsubmit="return false;">
            ...
            <div class="layui-input-inline">
                <select name="position_id" lay-filter="advert_positions" lay-verify="required">
                    ...
                    @foreach($advert_positions as $advert_position)
                        <option value="{{ $advert_position->id }}" title="{{ $advert_position->width }}*{{ $advert_position->height }}">{{ $advert_position->name }}</option>
                    @endforeach
                </select>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn" lay-submit="" lay-filter="advert_form">保存</button>
            </div>
        </div>
    </form>
</div>
