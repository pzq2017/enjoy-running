...
<script type="text/javascript">
    ...
    var route_url = {
        lists: '{{ route('admin.member.settled.teacher.lists') }}',
        show: '{{ route_uri('admin.member.settled.teacher.show') }}',
    };
    function Lists(page) {
        ...
        Common.dataTableRender(page, {
            ...
            cols: [[
                ...
                {field: 'created_at', title: '申请日期', sort: true, align: 'center'},
    ...
    function Show(id) {
        Common.loadPage(Common.getRealRoutePath(route_url.show, {teacher: id}), {}, function (page) {
            $('.card-box').addClass('hidden');
